...
export const AdminSignUp = () => {
  ...
  const handleDrop = (acceptedFiles) => {
    ...
    if (file && validTypes.includes(file.type)) {
      ...
      toast.error(t("adminsignup_invalid_type"));
    }
  };
  ...
  const handleSave = async () => {
    if (!image?.file && !existingImage) {
      toast.error(t("adminsignup_select_required"));
      return;
    }
    ...
    try {
      ...
      toast.success(t("adminsignup_save_success"));
      fetchExistingImage();
      ...
      toast.error(t("adminsignup_save_fail"));
      ...
      <div className="flex flex-col gap-14 max-w-[848px] mx-auto">
        <div className="flex flex-col gap-3.5">
          <h2 className="text-[#111727] font-medium">
            Upload Signup Wallpaper
          </h2>
          <p className="text-[#6C7275] text-sm">
            You can upload an image for the Signup wallpaper. By saving, the
